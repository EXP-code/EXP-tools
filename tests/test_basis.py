...
def test_config_dict_to_yaml():
    ...
    model = os.path.join(DATA_DIR, "plummer_halo_hf.txt")
    cache = os.path.join(DATA_DIR, "cache_plummer_halo.txt")
    ...
    config_file = os.path.join(DATA_DIR, "plummer_halo_config.yaml") 
...
def test_make_basis():
    ...
    test_cache = os.path.join(DATA_DIR, "cache_plummer_halo.txt")
