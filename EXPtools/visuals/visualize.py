...
#    
# def spherical_avg_prop(grid, basis, coefficients, times, radius=np.linspace(0.1, 600, 100), property='dens'):
#     """
...
#     #points = field.points(basis, coefficients)
#     
...
#
#
# def return_fields_in_grid(basis, coefficients, times, 
